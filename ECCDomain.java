...
/**
 * ECC Domain Parameter Set
 * @author Marco
 *
 * Specify Elliptic Curve Domain Parameters: Domain parameters for ECC
 ...
 *   The base point {@code G} is defined to generate our subgroup, whose {x} and {y} coordinates are denoted as {gx} and {gy}
